      ...
      <div className="container mx-auto px-4 max-w-6xl relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <p className="text-slate-600 text-sm md:text-base leading-relaxed">
            TechBETA 2026 2.0 will be hosted at the <strong>Conference Hall</strong>, St. Xavier&apos;s Catholic College of Engineering, Chunkankadai, Nagercoil. Symposium commences at <strong>9:00 AM</strong>.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          {/* Venue Card Details */}
          <div className="lg:col-span-5 flex flex-col justify-between space-y-6 bg-gradient-to-br from-slate-50 via-white to-blue-50/40 p-6 sm:p-8 rounded-3xl border border-slate-200/80 shadow-lg">
            <div>
                ...
                <div className="p-3.5 bg-blue-50/80 rounded-2xl border border-blue-200/70 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <span className="text-xs sm:text-sm font-extrabold text-slate-900">
                      October 13, 2026 &bull; 9:00 AM Onwards
                    </span>
                  </div>
                </div>
